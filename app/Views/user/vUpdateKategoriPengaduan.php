        ...
        <div id="content" class="content">
            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    ...
                    <?php endif ?>
                    <form action="<?php echo base_url('public/User/M_kategori_pengaduan/update_kategori_pengaduan') ?>"
                        ...
                        <div class="form-group row m-b-15">
                            ...
                            <div class="col-md-9 col-sm-9">
                                <input type="hidden" name="id_web" id="id_web"
                                    value="<?= $session->get('id_login'); ?>">
                                <input class="form-control" type="text" id="nama_dinas" name="nama_dinas"
                                    value="<?= $session->get('nama_login'); ?>" data-parsley-required="true" readonly />
                            </div>
                        </div>
                        <div class="form-group row m-b-15">
                            <label class="col-md-3 col-sm-3 col-form-label" for="title">Nama Kategori Pengaduan</label>
                            <div class="col-md-9 col-sm-9">
                                <input class="form-control" type="text" id="nama_kategori_pengaduan"
                                    name="nama_kategori_pengaduan" placeholder="Nama Kategori Pengaduan"
                                    data-parsley-required="true"
                                    value="<?php echo $kategori['NAMA_KATEGORI_PENGADUAN']; ?>" />
                            </div>
                        </div>
                        <div class="form-group row m-b-0">
                            ...
                            <div class="col-md-9 col-sm-9">
                                ...
                                <a href="<?php echo base_url('public/User/M_kategori_pengaduan') ?>" type="button"
