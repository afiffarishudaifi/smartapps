                        ...
                        <div class="panel-body">
                            <table id="data-table-responsive" style="width: 100%" class="table table-striped table-bordered table-td-valign-middle">
                                <thead>
                                    <tr>
                                        <th width="1%">No </th>
                                        <th class="text-nowrap" style="text-align: center;">Nama Foto</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <center>
                                                <a href="<?php base_url() ?>../../M_foto_tempat/detail_foto_tempat/<?php echo $item['ID_FOTO']; ?>" class="btn btn-circle btn-edit btn-warning"><i
                                                        class="fa fa-pen"></i></a>
                                                <a href="" class="btn btn-circle btn-delete btn-danger" data-toggle="modal"
                                                    data-target="#deleteModal" data-id="<?= $item['ID_FOTO']; ?>" data-tempat="<?= $item['ID_TEMPAT']; ?>"><i
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <h4>Apakah Ingin menghapus foto ini?</h4>
