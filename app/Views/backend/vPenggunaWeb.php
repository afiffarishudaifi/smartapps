    ...
    <div id="page-container"
        ...
        <div id="content" class="content">
            ...
            <ol class="breadcrumb float-xl-right">
                <a href="<?php echo base_url('public/Dashboard/M_pengguna_web/form_tambah') ?>" type="button"
        ...
        <!-- end #content -->
         ...
         <!-- Modal Delete Class-->
        <form action="<?php echo base_url('public/Dashboard/M_pengguna_web/delete_pengguna_web'); ?>" method="post">
