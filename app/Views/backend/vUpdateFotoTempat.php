        ...
        <div id="content" class="content">
            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    ...
                    <?php endif ?>
                    <form action="<?php echo base_url('Dashboard/M_foto_tempat/update_foto_tempat'); ?>"
                        ...
                        <div class="form-group row m-b-0">
                            ...
                            <div class="col-md-9 col-sm-9">
                                ...
                                <a href="<?php echo base_url('Dashboard/M_foto_tempat/view') . '/' . $foto_tempat['ID_TEMPAT']; ?>" type="button" 
