        ...
        <div id="content" class="content">
            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    ...
                    <?php endif ?>
                    <form action="<?php echo base_url('public/Dashboard/M_foto_tempat/update_foto_tempat'); ?>"
                        method="POST" enctype="multipart/form-data" class="form-horizontal" data-parsley-validate="true"
                        name="demo-form">
                        <?= csrf_field(); ?>
                        <input type="hidden" name="id_tempat" id="id_tempat" value="<?= $foto_tempat['ID_TEMPAT']; ?>">
                        <input type="hidden" name="id_foto" id="id_foto" value="<?= $foto_tempat['ID_FOTO']; ?>">
                        <div class="form-group row m-b-15">
                            <input type="hidden" name="foto" id="foto" value="<?php echo $foto_tempat['NAMA_FOTO']; ?>">
                            <label class="col-md-3 col-sm-3 col-form-label" for="file">Foto</label>
                            <div class="col-md-9 col-sm-9">
                                <input type="file" id="file" name="file" data-parsley-required="true"  />
                            </div>
                        </div>                 
                        <div class="form-group row m-b-0">
                            ...
                            <div class="col-md-9 col-sm-9">
                                ...
                                <a href="<?php echo base_url('public/Dashboard/M_foto_tempat/view') . '/' . $foto_tempat['ID_TEMPAT']; ?>" type="button" 
