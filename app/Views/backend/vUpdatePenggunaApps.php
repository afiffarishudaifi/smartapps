        ...
        <div id="content" class="content">
            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    ...
                    <?php endif ?>
                    <form action="<?php echo base_url('Dashboard/M_pengguna_apps/update_pengguna_apps') ?>"
                        method="POST" enctype="multipart/form-data" class="form-horizontal" data-parsley-validate="true"
                        name="demo-form">
                        <?= csrf_field(); ?>
                        <input type="hidden" name="id_pengguna_apps" id="id_pengguna_apps" value="<?php echo $apps['ID_PENGGUNA_APPS']; ?>"  >
                        <div class="form-group row m-b-15">
                            <label class="col-md-3 col-sm-3 col-form-label" for="title">KTP</label>
                            <div class="col-md-9 col-sm-9">
                                <input class="form-control <?= ($validation->hasError('ktp')) ? 'is-invalid' : ''; ?>" type="text" id="ktp" name="ktp" placeholder="KTP"
                                    data-parsley-required="true" data-parsley-minlength="16" data-parsley-maxlength="16"
                                    data-parsley-type="number" value="<?= (old('ktp')) ? old('ktp') : $apps['KTP']; ?>" />
                        ...
                        <div class="form-group row m-b-15">
                            ...
                            <div class="col-md-9 col-sm-9">
                                <input class="form-control <?= ($validation->hasError('username')) ? 'is-invalid' : ''; ?>" type="text" id="username" name="username"
                                    placeholder="Username" data-parsley-required="true" value="<?= (old('username')) ? old('username') : $apps['USERNAME_PENGGUNA_APPS']; ?>" />
                                <div class="invalid-feedback">
                        ...
                        <div class="form-group row m-b-15">
                            ...
                            <div class="col-md-9 col-sm-9">
                                <input class="form-control <?= ($validation->hasError('password')) ? 'is-invalid' : ''; ?>" type="text" id="password" name="password"
                                    placeholder="Password" data-parsley-required="true" data-parsley-minlength="8" value="<?= (old('password')) ? old('password') : $password; ?>" />
                                 <div class="invalid-feedback">
                        ...
                        <div class="form-group row m-b-15">
                            ...
                            <div class="col-md-9 col-sm-9">
                                <input class="form-control <?= ($validation->hasError('email')) ? 'is-invalid' : ''; ?>" type="email" id="email" name="email" placeholder="Email"
                                    data-parsley-required="true" data-parsley-type="email" value="<?= (old('email')) ? old('email') : $apps['EMAIL_PENGGUNA_APPS']; ?>"/>
                                 <div class="invalid-feedback">
                        ...
                        <div class="form-group row m-b-15">
                            ...
                            <div class="col-md-9 col-sm-9">
                                <input class="form-control <?= ($validation->hasError('nama_lengkap')) ? 'is-invalid' : ''; ?>" type="text" id="nama_lengkap" name="nama_lengkap"
                                    placeholder="Nama Lengkap" data-parsley-required="true" value="<?= (old('nama_lengkap')) ? old('nama_lengkap') : $apps['NAMA_LENGKAP_APPS']; ?>"/>
                                 <div class="invalid-feedback">
                        ...
                        <div class="form-group row m-b-15">
                            ...
                            <div class="col-md-9 col-sm-9">
                                <input class="form-control <?= ($validation->hasError('no_hp')) ? 'is-invalid' : ''; ?>" type="text" id="no_hp" name="no_hp" placeholder="No Hp"
                                    data-parsley-required="true" data-parsley-minlength="11"
                                    data-parsley-type="number" value="<?= (old('no_hp')) ? old('no_hp') : $apps['NO_HP_PENGGUNA_APPS']; ?>"/>
                                 <div class="invalid-feedback">
                        ...
                        <div class="form-group row m-b-15">
                            ...
                            <div class="col-md-9 col-sm-9">
                                <input class="form-control <?= ($validation->hasError('alamat')) ? 'is-invalid' : ''; ?>" type="text" id="alamat" name="alamat" placeholder="Alamat"
                                    data-parsley-required="true" value="<?= (old('alamat')) ? old('alamat') : $apps['ALAMAT_PENGGUNA_APPS']; ?>" />
                                 <div class="invalid-feedback">
                        ...
                        <div class="form-group row m-b-15">
                            <input type="hidden" name="foto" id="foto" value="<?php echo $apps['FOTO_PENGGUNA_APPS']; ?>">
                        ...
                        <div class="form-group row m-b-0">
                            ...
                            <div class="col-md-9 col-sm-9">
                                ...
                                <a href="<?php echo base_url('Dashboard/M_pengguna_apps') ?>" type="button"
