...
<body>
        ...
        <div id="content" class="content">
            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    ...
                    <?php endif ?>
                    <form action="<?php echo base_url('public/Dashboard/M_pengaduan/update_pengaduan') ?>"
    ...
    $(function() {
        ...
        $.getJSON('<?php echo base_url('public/Dashboard/M_pengaduan/data_edit_dropdown'); ?>' + '/' + isi, {},
            function(json) {
