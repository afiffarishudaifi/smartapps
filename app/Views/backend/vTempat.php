    ...
    <div id="page-container"
        ...
        <div id="content" class="content">
            ...
            <ol class="breadcrumb float-xl-right">
                <a href="<?php echo base_url('public/Dashboard/M_tempat/add_tempat') ?>" type="button"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <center>
                                                ...
                                                <a href="<?php base_url() ?>M_tempat/detail_tempat/<?php echo $item['ID_TEMPAT']; ?>" class="btn btn-circle btn-edit btn-warning"><i
                                                class="fa fa-pen"></i></a>
                                                <a href="" type="button" onclick="Hapus(<?= $item['ID_TEMPAT']; ?>)" class="btn btn-circle btn-danger" id="btn-delete" data-toggle="modal" data-target="#deleteModal"><i class="fa fa-trash"></i></a>
                                            </center>
                                        </td>
                                    </tr>
                                    <?php } ?>
        ...
        <!-- end #content -->
          ...
          <!-- Modal Delete Class-->
        <form action="<?php echo base_url('public/Dashboard/M_tempat/delete_tempat'); ?>" method="post">
