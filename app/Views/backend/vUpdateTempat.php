            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    ...
                    <form action="<?php echo base_url('Dashboard/M_tempat/update_tempat') ?>" method="POST"
                        ...
                        name="demo-form">
                        <?= csrf_field(); ?>
                        <input type="hidden" name="id_tempat" id="id_tempat" value="<?= $tempat['ID_TEMPAT']; ?>">
                        ...
                        <div class="form-group row m-b-15">
                            ...
                            <div class="col-md-9 col-sm-9">
                                <input class="form-control" type="text" id="nama_tempat" name="nama_tempat"
                                    placeholder="Nama Tempat" data-parsley-required="true" value="<?= $tempat['NAMA_TEMPAT']; ?>" />
                            </div>
                        </div>
                        <div class="form-group row m-b-15">
                            ...
                            <div class="col-md-9 col-sm-9">
                                <input class="form-control" type="text" id="long_tempat" name="long_tempat"
                                    placeholder="Longitude Tempat" data-parsley-required="true" value="<?= $tempat['LONG_TEMPAT']; ?>"/>
                            </div>
                        </div>
                        <div class="form-group row m-b-15">
                            ...
                            <div class="col-md-9 col-sm-9">
                                <input class="form-control" type="text" id="lat_tempat" name="lat_tempat"
                                    placeholder="Latitude Tempat" data-parsley-required="true" value="<?= $tempat['LAT_TEMPAT']; ?>" />
                            </div>
                        </div>
                        <div class="form-group row m-b-15">
                            ...
                            <div class="col-md-9 col-sm-9">
                                <input class="form-control" type="text" id="alamat_tempat" name="alamat_tempat"
                                    placeholder="Alamat Tempat" data-parsley-required="true" value="<?= $tempat['ALAMAT_TEMPAT']; ?>" />
                            </div>
                        </div>
                        <div class="form-group row m-b-15">
                            <label class="col-md-3 col-sm-3 col-form-label" for="title">Deskripsi Tempat</label>
                            <div class="col-md-9 col-sm-9">
                                <textarea class="form-control" type="text" id="deskripsi_tempat" name="deskripsi_tempat"
                                    data-parsley-required="true"><?= $tempat['DESKRIPSI_TEMPAT']; ?></textarea>
                            </div>
                        </div>
                        <div class="form-group row m-b-15">
                            ...
                            <div class="col-md-9 col-sm-9">
                                <input class="form-control" type="text" id="no_telp_tempat" name="no_telp_tempat"
                                    placeholder="No Telp Tempat" data-parsley-required="true" value="<?= $tempat['NO_TELP_TEMPAT']; ?>" />
                            </div>
                        </div>
                        <div class="form-group row m-b-15">
                            ...
                            <div class="col-md-9 col-sm-9">
                                ...
                                <?php if( $tempat['STATUS_TEMPAT'] == 'Pengajuan' ) {?>
        ...
        $.getJSON('<?php echo base_url('Dashboard/M_tempat/data_edit_dropdown'); ?>' + '/' + isi, {},
            function(json) {
                ...
                $('#id_pengguna_apps').trigger('change');
                 ...
                 $('#id_kategori_tempat').append('<option selected value="' + json.id_kategori_tempat + '">' + json.nama_kategori_tempat +
                    '</option>');
                $('#id_kategori_tempat').select2('data', {
                    id: json.id_kategori_tempat,
                    text: json.nama_kategori_tempat
                });
                $('#id_kategori_tempat').trigger('change');
            });
    })
    </script>
</body>
