    ...
    <div id="page-container"
        ...
        <div id="content" class="content">
            ...
            <ol class="breadcrumb float-xl-right">
                <a href="<?php echo base_url('public/Dashboard/M_komentar/form_tambah') ?>" type="button"
                        ...
                        <div class="panel-body">
                            <table id="data-table-responsive" style="width: 100%"
                                ...
                                <thead>
                                    <tr>
                                        <th width="1%">No </th>
                                        <th class="text-nowrap" style="text-align: center;">Komentar</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <center>
                                                <a href="<?php base_url() ?>M_komentar/detail_komentar/<?php echo $item['ID_KOMENTAR']; ?>"
                                                    class="btn btn-circle btn-edit btn-warning"><i
                                                        class="fa fa-pen"></i></a>
                                                <a href="" class="btn btn-circle btn-delete btn-danger"
                                                    data-toggle="modal" data-target="#deleteModal"
                                                    data-id="<?= $item['ID_KOMENTAR']; ?>"><i
        ...
        <!-- Modal Delete Class-->
        <form action="<?php echo base_url('public/Dashboard/M_komentar/delete_komentar'); ?>" method="post">
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <h4>Apakah Ingin menghapus komentar ini?</h4>

                        </div>
                        <div class="modal-footer">
                            <input type="hidden" name="id_komentar" class="id_komentar">
