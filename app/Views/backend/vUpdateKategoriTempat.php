        ...
        <div id="content" class="content">
            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    ...
                    <?php endif ?>
                    <form
                        action="<?php echo base_url('Dashboard/M_kategori_tempat/update_kategori_tempat') ?>"
                        method="POST" enctype="multipart/form-data" class="form-horizontal" data-parsley-validate="true"
                        name="demo-form">
                        <?= csrf_field(); ?>
                        <input type="hidden" name="id_kategori_tempat" id="id_kategori_tempat" value="<?= $kategori['ID_KATEGORI_TEMPAT']; ?>">
                        <div class="form-group row m-b-15">
                            <label class="col-md-3 col-sm-3 col-form-label" for="title">Nama Kategori</label>
                            <div class="col-md-9 col-sm-9">
                                <input class="form-control <?= ($validation->hasError('nama_kategori')) ? 'is-invalid' : ''; ?>" type="text" id="nama_kategori" name="nama_kategori"
                                    placeholder="Nama Kategori Tempat" data-parsley-required="true" value="<?= (old('nama_kategori')) ? old('nama_kategori') : $kategori['NAMA_KATEGORI_TEMPAT']; ?>" />
                        ...
                        <div class="form-group row m-b-0">
                            ...
                            <div class="col-md-9 col-sm-9">
                                ...
                                <a href="<?php echo base_url('Dashboard/M_kategori_tempat') ?>" type="button"
