        ...
        <div id="content" class="content">
            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    ...
                    <?php endif ?>
                    <form action="<?php echo base_url('public/Dashboard/M_foto_tempat/add_foto_tempat') . '/' . $id_tempat; ?>"
                        method="POST" enctype="multipart/form-data" class="form-horizontal" data-parsley-validate="true"
                        name="demo-form">
                        <?= csrf_field(); ?>
                        <input type="hidden" name="id_tempat" id="id_tempat" value="<?= $id_tempat; ?>">
                        ...
                        <div class="form-group row m-b-0">
                            ...
                            <div class="col-md-9 col-sm-9">
                                ...
                                <a href="<?php echo base_url('public/Dashboard/M_foto_tempat/view') . '/' . $id_tempat; ?>" type="button"
