                        ...
                        <div class="panel-body">
                            <table id="data-table-responsive" style="width: 100%"
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td width="1%"><?= $no++; ?></td>
                                        <td><?= $item['NAMA_KATEGORI_TEMPAT']; ?></td>
                                        <td>
                                            <center>
                                                <a href="<?php base_url() ?>M_kategori_tempat/detail_kategori_tempat/<?php echo $item['ID_KATEGORI_TEMPAT']; ?>"
                                                    class="btn btn-circle btn-edit btn-warning"><i
                                                        class="fa fa-pen"></i></a>
                                                <a href="" class="btn btn-circle btn-delete btn-danger"
                                                    data-toggle="modal" data-target="#deleteModal"
                                                    data-id="<?= $item['ID_KATEGORI_TEMPAT']; ?>"><i
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <h4>Apakah Ingin menghapus Kategori Tempat ini?</h4>
