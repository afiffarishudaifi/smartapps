        ...
        <div id="content" class="content">
            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    ...
                    <?php endif ?>
                    <form action="<?php echo base_url('public/Dashboard/M_pengguna_web/update_pengguna_web') ?>"
                        ...
                        <div class="form-group row m-b-15">
                            ...
                            <div class="col-md-9 col-sm-9">
                                <input class="form-control <?= ($validation->hasError('username_web')) ? 'is-invalid' : ''; ?>" type="text" id="username_web" name="username_web"
                                    placeholder="Username" data-parsley-required="true" value="<?= (old('username_web')) ? old('username_web') : $web['USERNAME_WEB']; ?>" />
                        ...
                        <div class="form-group row m-b-15">
                            ...
                            <div class="col-md-9 col-sm-9">
                                <input class="form-control <?= ($validation->hasError('password_web')) ? 'is-invalid' : ''; ?>" type="text" id="password_web" name="password_web"
                                    placeholder="Password" value="<?= (old('password_web')) ? old('password_web') : $password; ?>" data-parsley-required="true" data-parsley-minlength="8" />
                                 <div class="invalid-feedback">
                        ...
                        <div class="form-group row m-b-15">
                            ...
                            <div class="col-md-9 col-sm-9">
                                <input class="form-control <?= ($validation->hasError('email_web')) ? 'is-invalid' : ''; ?>" type="email" id="email_web" name="email_web" placeholder="Email"
                                    data-parsley-required="true" data-parsley-type="email" value="<?= (old('email_web')) ? old('email_web') : $web['EMAIL_WEB']; ?>" />
                                 <div class="invalid-feedback">
                        ...
                        <div class="form-group row m-b-15">
                            ...
                            <div class="col-md-9 col-sm-9">
                                <input class="form-control <?= ($validation->hasError('nama_web')) ? 'is-invalid' : ''; ?>" type="text" id="nama_web" name="nama_web"
                                    placeholder="Nama Pengguna Web" data-parsley-required="true" value="<?= (old('nama_web')) ? old('nama_web') : $web['NAMA_WEB']; ?>"/>
                                 <div class="invalid-feedback">
                        ...
                        <div class="form-group row m-b-15">
                            ...
                            <div class="col-md-9 col-sm-9">
                                <input class="form-control <?= ($validation->hasError('no_telp_web')) ? 'is-invalid' : ''; ?>" type="text" id="no_telp_web" data-parsley-minlength="10" name="no_telp_web" placeholder="No Telp web" data-parsley-required="true" data-parsley-type="number" value="<?= (old('no_telp_web')) ? old('no_telp_web') : $web['NO_TELP_WEB']; ?>"/>
                                 <div class="invalid-feedback">
                        ...
                        <div class="form-group row m-b-15">
                            ...
                            <div class="col-md-9 col-sm-9">
                                <input class="form-control <?= ($validation->hasError('alamat_web')) ? 'is-invalid' : ''; ?>" type="text" id="alamat_web" name="alamat_web" placeholder="Alamat Pengguna Web" data-parsley-required="true" value="<?= (old('alamat_web')) ? old('alamat_web') : $web['ALAMAT_WEB']; ?>" />
                                 <div class="invalid-feedback">
                        ...
                        <div class="form-group row m-b-0">
                            ...
                            <div class="col-md-9 col-sm-9">
                                ...
                                <a href="<?php echo base_url('public/Dashboard/M_pengguna_web') ?>" type="button"
