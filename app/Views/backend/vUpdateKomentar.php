        ...
        <div id="content" class="content">
            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    ...
                    <?php endif ?>
                    <form action="<?php echo base_url('public/Dashboard/M_komentar/update_komentar') ?>"
                        method="POST" enctype="multipart/form-data" class="form-horizontal" data-parsley-validate="true"
                        name="demo-form">
                        <?= csrf_field(); ?>
                        <input type="hidden" name="id_komentar" id="id_komentar" value="<?= $komentar['ID_KOMENTAR']; ?>">
                        ...
                        <div class="form-group row m-b-15">
                            ...
                            <div class="col-md-9 col-sm-9">
                                <input class="form-control" type="text" id="isi_komentar" name="isi_komentar"
                                    placeholder="Isi Komentar" data-parsley-required="true" value="<?= $komentar['ISI_KOMENTAR']; ?>" />
                            </div>
                        </div>
                        <div class="form-group row m-b-0">
                            ...
                            <div class="col-md-9 col-sm-9">
                                ...
                                <a href="<?php echo base_url('public/Dashboard/M_komentar') ?>" type="button"
    ...
    <script type="text/javascript">
        $(function() {
            $('#id_pengguna_apps').select2({
                placeholder: "Pilih Aplikasi Android",
                theme: 'bootstrap4',
                ajax: {
                    url: '<?php echo base_url('public/Dashboard/M_komentar/data_apps'); ?>',
                    dataType: 'json'
                }
            });
            ...
            $('#id_tempat').select2({
                ...
                theme: 'bootstrap4',
                ajax: {
                    url: '<?php echo base_url('public/Dashboard/M_komentar/data_tempat'); ?>',
                    dataType: 'json'
                }
            });

            var isi = document.getElementById("id_komentar").value;
            $.getJSON('<?php echo base_url('public/Dashboard/M_komentar/detail_dropdown'); ?>' + '/' + isi, {},
                function(json) {
                    ...
                    $('#id_tempat').append('<option selected value="' + json.id_tempat + '">' + json.nama_tempat +
                        '</option>');
                    $('#id_tempat').select2('data', {
                        id: json.id_tempat,
                        text: json.nama_tempat
                    });
                    $('#id_tempat').trigger('change');
                });
        })
    </script>
    <!-- ================== END PAGE LEVEL JS ================== -->
