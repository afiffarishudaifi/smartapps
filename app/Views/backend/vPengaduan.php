                            ...
                            <table id="data-table-responsive" style="width: 100%"
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <center>
                                                <a href="<?php base_url() ?>M_pengaduan/detail_pengaduan/<?php echo $item['ID_PENGADUAN']; ?>" class="btn btn-circle btn-edit btn-warning"><i
                                                class="fa fa-pen"></i></a>

                                                 <a href="" type="button" onclick="Hapus(<?= $item['ID_PENGADUAN']; ?>)" class="btn btn-circle btn-danger" id="btn-delete" data-toggle="modal" data-target="#deleteModal"><i class="fa fa-trash"></i></a>
                                            </center>
                                        </td>
                                    </tr>
                                    <?php } ?>
